...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  illustrations = [
    ...
    { id: 'bissap', nom: 'Fleurs de Bissap', url: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=300&h=300&fit=crop' },
    { id: 'arachides', nom: 'Arachides', url: 'https://images.unsplash.com/photo-1528751014936-863e6e7a319c?w=300&h=300&fit=crop' },
