...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  illustrations = [
    ...
    { id: 'bissap', nom: 'Fleurs de Bissap', url: '/assets/illustrations/bissap.png' },
    { id: 'arachides', nom: 'Arachides', url: '/assets/illustrations/arachides.svg' },
  ...
  ajouterProduit() {
    ...
    formData.append('categorie_id', '1');
        let photoUrl = this.nouveauProduit.image || '';
    if (photoUrl.startsWith('data:image')) {
      if (nomSaisi.includes('bissap')) {
        photoUrl = '/assets/illustrations/bissap.png';
      } else if (nomSaisi.includes('arachide')) {
        photoUrl = '/assets/illustrations/arachides.svg';
      }
    }
